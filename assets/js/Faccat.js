...
function exercicio02() {
    ...
    var numero2 = parseInt(prompt("Escreva outro numero: "))

    var subtracao = numero1 - numero2
    alert("Resultado da subtração é : " + subtracao)

}
function exercicio03() {
    var numero1 = parseFloat(prompt("Digite um numero para fazer a multiplicação:"))
    var numero2 = parseFloat(prompt("Digite outro numero para fazer a multiplicação: "))
...
function exercicio04() {
    var numero1 = parseFloat(prompt("Digite um numero para fazer a divisão: "))
    var numero2 = parseFloat(prompt("digite outro numero para fazer a divisão: "))
...
function exercicio05() {
    ...
    var valor1 = parseInt(prompt("Digite um numero para descobrir o antecessor: "))

    var ante = valor1 - 1
    alert("o antecessor do numero é: " + ante)
}
